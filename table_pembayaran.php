                ...
                <div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form method=post action=table_pembayaran.php class="form-horizontal">
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">ID Pembayaran</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="id_pemb" placeholder="id pembayaran" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">ID Penjualan</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="id_penj" placeholder="id penjualan" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Tanggal Pembayaran</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="tgl_pemb" placeholder="tanggal pembayaran" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Jumlah Pembayaran</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="jumlah_pemb" placeholder="jumlah pembayaran" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Metode Pembayaran</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="met_pemb" placeholder=" metode pembayaran" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Tanggal Pengiriman</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="tgl_kirim" placeholder=" tanggal pengiriman" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Status Pengiriman</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="sts_kirim" placeholder=" status pengiriman" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Alamat Pengiriman</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="alamat_kirim" placeholder=" alamat pengiriman" class="form-control"></div>
                          </div>
                      ...
                      <div class="card-footer">
						...
						if(isset($_POST['insert'])=="Insert") {
							...
							$sql="INSERT INTO pembayaran_pengiriman (ID_pembayaran_pengiriman, ID_penjualan, tanggal_pembayaran, jumlah_pembayaran, metode_pembayaran, tanggal_pengiriman, status_pengiriman, alamat_pengiriman)
							VALUES
							('$_POST[id_pemb]','$_POST[id_penj]','$_POST[tgl_pemb]',$_POST[jumlah_pemb],'$_POST[met_pemb]','$_POST[tgl_kirim]','$_POST[sts_kirim]','$_POST[alamat_kirim]')";
...
if (isset($_POST['update']) && $_POST['update'] == "Update") {
    ...
    $tgl_pemb = $_POST['tgl_pemb'];
    $jumlah_pemb = $_POST['jumlah_pemb'];
    $met_pemb = $_POST['met_pemb'];
    ...
    $sql = "UPDATE pembayaran_pengiriman SET 
            ID_penjualan = '$id_penj', 
            tanggal_pembayaran = '$tgl_pemb', 
            jumlah_pembayaran = '$jumlah_pemb', 
            metode_pembayaran = '$met_pemb', 
            tanggal_pengiriman = '$tgl_kirim', 
            status_pengiriman = '$sts_kirim', 
            alamat_pengiriman = '$alamat_kirim'
            WHERE ID_pembayaran_pengiriman = '$id_pemb'";
...
?>
                        ...
                        $con=mysqli_connect("localhost", "root", "", "shop");
                        $sql="DELETE FROM pembayaran_pengiriman WHERE ID_pembayaran_pengiriman ='$_POST[id_pemb]'";
                  ...
                  echo "</tbody></table>";
						...
						<!--Cetak PRINT -->
						<a href="cetakPembayaran.php" target="_blank"><input type=submit class="btn btn-primary btn-sm" name=insert value=Cetak></a>
                    </div>
                </div>
                </div>
            </div><!-- .animated -->
