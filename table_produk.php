            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="table_penjualan.php">Tabel Penjualan Form</a></li>
                ...
                <div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form method=post action=table_produk.php class="form-horizontal">
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">ID Produk</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="id_prod" placeholder="id produk" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Nama Produk</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="nama_prod" placeholder="nama produk" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Harga Produk</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="harga_prod" placeholder="harga produk" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Deskripsi Produk</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="deskripsi" placeholder="deskripsi produk" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Tanggal Expired</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="tgl_expired" placeholder="tgl expired" class="form-control"></div>
                          </div>
                        
                      </div>
                      <div class="card-footer">
                        <input type=submit class="btn btn-outline-info" name=insertProd value=Insert>
                        <input type=submit class="btn btn-outline-info" name=updateProd value=Update>
                        <input type=submit class="btn btn-outline-info" name=deleteProd value=Delete>
						...
						<?php
						if(isset($_POST['insertProd'])=="Insert") {
							$con=mysqli_connect("localhost", "root", "", "shop");
							$sql="INSERT INTO produk (ID_Product, NamaProduk, Harga, Deskripsi, Expired)
							VALUES
							('$_POST[id_prod]','$_POST[nama_prod]',$_POST[harga_prod],'$_POST[deskripsi]','$_POST[tgl_expired]')";
                        ...
                        <?php
                        if(isset($_POST['updateProd'])=="Update") {
                        $con=mysqli_connect("localhost", "root", "", "shop");
                        $sql="UPDATE produk SET NamaProduk ='$_POST[nama_prod]', 
                        Harga='$_POST[harga_prod]', Deskripsi='$_POST[deskripsi]', Expired= DATE '$_POST[tgl_expired]'
                        WHERE ID_Product='$_POST[id_prod]'";
                        ...
                        <?php
                        if(isset($_POST['deleteProd'])=="Delete") {
                        $con=mysqli_connect("localhost", "root", "", "shop");
                        $sql="DELETE FROM produk WHERE ID_Product ='$_POST[id_prod]'";
                  ...
                  echo "</tbody></table>";
						...
						<!--Cetak PRINT -->
						<a href="cetakProduk.php" target="_blank"><input type=submit class="btn btn-primary btn-sm" name=insert value=Cetak></a>
                    </div>
                </div>
                </div>
            </div><!-- .animated -->
