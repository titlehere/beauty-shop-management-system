                ...
                <div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form method=post action=table_penjualan.php class="form-horizontal">
                          ...
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Tanggal Penjualan</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="tgl_penj" placeholder="tgl penjualan" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                          ...
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Jumlah Produk</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="jumlah_prod" placeholder="jumlah produk" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Total Harga</label></div>
                            <div class="col col-sm-6"><input type=text id="input-normal" name="total_harga" placeholder=" total harga" class="form-control"></div>
                          </div>
                      ...
                      <div class="card-footer">
						...
						<?php
                            if (isset($_POST['insert']) && $_POST['insert'] == "Insert") {
                                ...
                                $tgl_penj = $_POST['tgl_penj'];
                                $id_prod = $_POST['id_prod'];
                                $jumlah_prod = $_POST['jumlah_prod'];
                                $total_harga = $_POST['total_harga'];

                                
                                $sql = "INSERT INTO penjualan (id_penjualan, tgl_penjualan, id_produk, jumlah_produk, total_harga)
                                        VALUES ('$id_penj', '$tgl_penj', '$id_prod', $jumlah_prod, $total_harga)";
                        ...
                        if (isset($_POST['update']) && $_POST['update'] == "Update") {
                            ...
                            $sql = "UPDATE penjualan SET 
                                    tgl_penjualan = '$tgl_penj', 
                                    id_produk = '$id_prod', 
                                    jumlah_produk = $jumlah_prod, 
                                    total_harga = $total_harga
                                    WHERE id_penjualan = '$id_penj'";
                        ...
                        $con=mysqli_connect("localhost", "root", "", "shop");
                        $sql="DELETE FROM penjualan WHERE id_penjualan ='$_POST[id_penj]'";
                  ...
                  echo "</tbody></table>";
						...
						<!--Cetak PRINT -->
						<a href="cetakPenjualan.php" target="_blank"><input type=submit class="btn btn-primary btn-sm" name=insert value=Cetak></a>
                    </div>
                </div>
                </div>
            </div><!-- .animated -->
